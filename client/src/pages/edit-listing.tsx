...
export default function EditListing() {
  ...
  // Update form with existing property data
  useEffect(() => {
    if (property) {
      form.reset({
  ...
  const updateProperty = useMutation({
    ...
    onSuccess: (updatedProperty) => {
      ...
      toast({
        ...
        description: "Dine ændringer er gemt succesfuldt",
      });
      navigate(`/bolig/${updatedProperty.id}`);
    },
    onError: (error: Error) => {
      toast({
        title: "Fejl",
  ...
  const onSubmit = (data: InsertProperty) => {
    ...
    updateProperty.mutate(propertyData);
  };
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="flex justify-end gap-4 pt-6 border-t">
                  ...
                  <Button type="submit" disabled={updateProperty.isPending}>
                    {updateProperty.isPending ? "Gemmer..." : "Gem ændringer"}
                  </Button>
                </div>
              </form>
            </Form>
